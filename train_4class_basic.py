"""
Train 4-Class Model - Basic Approach
Classes: Flystrike, Healthy, Orf, Sheep Scab (NO Ringworm)
"""
...
print(f"✅ MobileNetV2-based 4-class model")
...
plt.tight_layout()
plt.savefig('training_4class_basic.png')
...
print("\n" + "="*60)
if final_val >= 0.92:
    print("✅ GOOD ACCURACY! Check if predictions are balanced.")
    print("   If balanced → Use this model!")
    print("   If biased → Try fine-tuning (Script 2)")
else:
    print("⚠️  Lower accuracy. Try fine-tuning (Script 2)")
print("="*60)